...
const ViewBookingCard = ({
    ...
    const extractedBookingId = typeof bookingId === 'object' ? bookingId.id.toString() : bookingId.toString();
                ...
                <Table>
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="center">
                                <Button variant="contained" sx={buttonStyle} onClick={remove}>Cancel Booking</Button>
                            </TableCell>
                        </TableRow>
                    </TableHead>
                </Table>
                ...
                <Box sx={style}>
                    ...
                    <Grid container spacing={2} sx={{ mt: 2 }}>
                        <Grid item xs={12}>
                            ...
                            <Typography variant="body1">Booking Status: {bookingStatus || "Pending"}</Typography>
                        </Grid>
                        <Grid item xs={12}>
                        ...
                        <Grid item xs={12}>
                            <Button variant="contained" sx={buttonStyle}  onClick={addGuestAge}>Add Guest Age</Button>
                        </Grid>
                        ...
                        <Grid item xs={12}>
                            <Button variant="contained" sx={buttonStyle} onClick={addRoomId}>Add Room ID</Button>
                        </Grid>
                    </Grid>
